...
public class Office365Authenticator extends OpenIDConnectAuthenticator implements FederatedApplicationAuthenticator {
    ...
    public List<Property> getConfigurationProperties() {
        ...
        clientId.setDescription("Enter Outlook IDP client identifier value");
        ...
        clientSecret.setDescription("Enter Outlook IDP client secret value");
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request,
        ...
        String redirectUri = authenticatorProperties.get(Office365AuthenticatorConstants.REDIRECT_URI);
        String loginPage = getAuthorizationServerEndpoint(context.getAuthenticatorProperties());
        String queryParams = "state" + "=" + context.getContextIdentifier();
        try {
            response.sendRedirect(response.encodeRedirectURL(loginPage + "?" + queryParams + "&" +
                    Office365AuthenticatorConstants.CLIENT_ID + "=" + clientId + "&" + "response_type=" +
                    OIDCAuthenticatorConstants.OAUTH2_GRANT_TYPE_CODE + "&" + "redirect_uri=" + redirectUri + "&" +
                    Office365AuthenticatorConstants.Resource + "=https://outlook.office.com"));
        } catch (IOException e) {
    ...
    protected void processAuthenticationResponse(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            String id = claims.get(ClaimMapping.build(Office365AuthenticatorConstants.ID,
                    Office365AuthenticatorConstants.ID, (String) null, false));
            AuthenticatedUser authenticatedUserObj =
                    AuthenticatedUser.createFederateAuthenticatedUserFromSubjectIdentifier((String) obj.get(Office365AuthenticatorConstants.ID));
    ...
    protected String sendRequest(String url, String accessToken) throws IOException {
        ...
        urlConnection.setRequestProperty("Accept", "application/json;odata.metadata=minimal");
